    ...
    <div class="card">
      ...
      <div style="margin-bottom:20px">
        ...
        <table style="margin-top:12px">
          ...
          <tr><td>Kondigre - Sarika</td><td><input type="number" value="0" style="width:80px"></td><td><input type="number" value="0" style="width:80px"></td></tr>
          <tr><td>Nimshirgav - Kumar</td><td><input type="number" value="0" style="width:80px"></td><td><input type="number" value="0" style="width:80px"></td></tr>
